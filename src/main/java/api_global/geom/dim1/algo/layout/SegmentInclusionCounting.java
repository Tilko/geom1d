package api_global.geom.dim1.algo.layout;

import java.util.ArrayList;
import java.util.stream.Collectors;
import java.util.stream.Stream;

import org.gmart.util.functionalProg.math.counter.CounterImpl;
...
public class SegmentInclusionCounting {
	...
	public static class NodeBase implements INode {
		...
		public boolean includeStrict(Seg other) {
			return seg.includeStrict(other);
		}
